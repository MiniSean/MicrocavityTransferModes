...
if __name__ == '__main__':
    ...
    for long_mode in range(len(ax_array)):
        ...
        plot_isolated_long_mode(axis=ax_array[long_mode], data_class=meas_iterations[index], collection=labeled_peaks[index], long_mode=long_mode)
        if long_mode == 1:
