...
def export_video_intensity(filename: str):
...
if __name__ == '__main__':
    ...
    filename = '07-12_800sec_mode_scanning_15FPS'  # 'test_01' 'pol000_exp005_gain800'
    export_video_intensity(filename=filename)
